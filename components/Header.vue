        ...
        <div class="flex items-center gap-8">
          ...
          <nav class="hidden md:block">
            <ul class="flex space-x-8">
              ...
              <li><a href="#attorneys" class="text-[var(--color-text-dark)] hover:text-[var(--color-accent-500)] transition-colors font-[var(--font-sans)] tracking-wide">Attorneys</a></li>
          ...
          <div class="md:hidden">
            <button class="text-[var(--color-text-dark)]">
